...
//	
//	StudentTest s1=new StudentTest(1,"Yoga" , 22);  // parameterized constructor asking for value that declare in Student Constructor
//	StudentTest s2=new StudentTest(2,"Camp" , 23);
//	StudentTest s3=new StudentTest(3,"Champ" , 21);
//	StudentTest s4=new StudentTest(4,"Poco" , 24);
//	
